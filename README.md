...
## Purpose
    ...
    This project is mainly for practicing front-end skills (HTML5, CSS, JavaScript)
    The goal with this site was to provide a small, maintainable way to display content.

## Key features

    Semantic structure: header, main, article, footer
    Interactive navigation — navigate through swapping content instead of solely using page reloads.
    Separating content with variables for history and nature sections.
    Flexible figure/caption area for images and attributions.

## Technical details

    Files: index.html (main markup), form.html (contact page), design/style.css (main stylesheet), main.js (DOM logic — inline for demo)
    Vanilla JavaScript — no frameworks used.
    Data-driven rendering: state content is stored in variables and injected into the DOM when a state is selected.
